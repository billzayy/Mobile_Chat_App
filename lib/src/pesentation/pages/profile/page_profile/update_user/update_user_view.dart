      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: Get.theme.textTheme.titleLarge
              ?.copyWith(color: Get.theme.colorScheme.onBackground, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
        ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Update', style: Get.theme.textTheme.bodyMedium?.copyWith(color: Colors.white)),
              ),
            ),
          ],
        ),
